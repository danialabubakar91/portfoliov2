...
const Home: React.FC = () => {
  ...
  return (
    <div className="flex h-screen overflow-y-hidden">
      <div className="hidden bg-red-400 md:w-2/6 md:p-6 md:flex md:flex-col md:items-center ">
        <img
            ...
            <li className="mb-4 group">
              <span
                ...
                ${
                  aboutOn
                    ? "w-2 bg-black"
                    : "group-hover:w-2 group-hover:bg-black"
                }`}
              />
      ...
      <div className="w-full bg-green-400 overflow-y-auto md:w-4/6 md:p-5p md:py-6 ">
        <img
        ...
        <section
          ref={aboutRef}
          id="about"
          className="min-h-3/4 pb-24 border border-blue-500"
        >
          <h2 className="text-xl mb-1">Hello! My name is...</h2>
          <h1 className="text-4xl mb-1">Danial Abu Bakar</h1>
        ...
        <section
          ref={skillsRef}
          id="skills"
          className="min-h-3/4 border border-blue-500 grid grid-cols-2 gap-4"
        >
          <div className="border border-red-400 py-5p px-10p">
            <h1 className="mb-3">Frontend Frameworks</h1>
            <p>ReactJS 60%</p>
            <div className="w-full h-3 mb-2 border border-violet-800 rounded-md">
              <div className="w-60p h-full border rounded-md bg-pink-400"></div>
            </div>
            <p>Tailwind CSS 60%</p>
            <div className="w-full h-3 mb-2 border border-violet-800 rounded-md">
              <div className="w-60p h-full border rounded-md bg-pink-400"></div>
            ...
            <p>Radix UI 30%</p>
            <div className="w-full h-3 mb-2 border border-violet-800 rounded-md">
              <div className="w-40p h-full border rounded-md bg-pink-400"></div>
            </div>
          </div>
          <div className="border border-red-400 py-5p px-10p">
            ...
            <p>Spring Boot 70%</p>
            <div className="w-full h-3 mb-2 border border-violet-800 rounded-md">
              <div className="w-70p h-full border rounded-md bg-pink-400"></div>
            </div>
            <p>NodeJS 20%</p>
            <div className="w-full h-3 mb-2 border border-violet-800 rounded-md">
              <div className="w-20p h-full border rounded-md bg-pink-400"></div>
            </div>
            <p>ExpressJS 30%</p>
            <div className="w-full h-3 mb-2 border border-violet-800 rounded-md">
              <div className="w-30p h-full border rounded-md bg-pink-400"></div>
            </div>
          </div>
          <div className="border border-red-400 py-5p px-10p">
            ...
            <div className="w-full h-3 mb-2 border border-violet-800 rounded-md">
              <div className="w-50p h-full border rounded-md bg-pink-400"></div>
            </div>
          </div>
          <div className="border border-red-400 py-5p px-10p">
            ...
            <p>Java 80%</p>
            <div className="w-full h-3 mb-2 border border-violet-800 rounded-md">
              <div className="w-80p h-full border rounded-md bg-pink-400"></div>
            </div>
          </div>
          <div className="border border-red-400 py-5p px-10p col-span-2">
            ...
            <p>Postman 90%</p>
            <div className="w-full h-3 mb-2 border border-violet-800 rounded-md">
              <div className="w-90p h-full border rounded-md bg-pink-400"></div>
            </div>
        ...
        <section
          ref={experienceRef}
          id="experience"
          className="min-h-3/4 border border-blue-500"
        >
          Experience
        </section>
      </div>
